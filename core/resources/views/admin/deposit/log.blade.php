                            ...
                            <tbody>
                                @forelse($deposits as $deposit)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-outline--primary ms-1" href="@if ($deposit->order_id) {{ route('admin.payment.details', $deposit->id) }} @else {{ route('admin.deposit.details', $deposit->id) }} @endif">
