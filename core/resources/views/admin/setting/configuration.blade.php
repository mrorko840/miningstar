                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                            <div>
                                ...
                                <p class="mb-0">
                                    <small>@lang('If you enable this module, the system will enable referral module, any user can invite persons to use the system, referrer also get commission as per commission settings.') </small>
                                </p>
                            </div>
                            <div class="form-group">
