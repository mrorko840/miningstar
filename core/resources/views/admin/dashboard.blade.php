        ...
        <div class="col-xxl-3 col-sm-6">
            <div class="widget-two box--shadow2 b-radius--5 bg--white">
                ...
                <div class="widget-two__content">
                    <h3>{{ $widget['total_miner'] }}</h3>
                    <p>@lang('Total Miner')</p>
                </div>
                <a class="widget-two__btn border--info btn-outline--info border" href="{{ route('admin.miner.index') }}">@lang('View All')</a>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <div class="widget-two box--shadow2 b-radius--5 bg--white">
                ...
                <div class="widget-two__content">
                    <h3>{{ $widget['total_plan'] }}</h3>
                    <p>@lang('Total Plan')</p>
                </div>
                <a class="widget-two__btn border--primary btn-outline--primary border" href="{{ route('admin.plan.index') }}">@lang('View All')</a>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <div class="widget-two box--shadow2 b-radius--5 bg--white">
                <i class="las la-list-alt overlay-icon text--success"></i>
                <div class="widget-two__icon b-radius--5 bg--success">
                    <i class="las la-list-alt"></i>
                </div>
                <div class="widget-two__content">
                    <h3>{{ $widget['total_sale_count'] }}</h3>
                    <p>@lang('Total Sale')</p>
                </div>
                <a class="widget-two__btn border--success btn-outline--success border" href="{{ route('admin.order.index') }}">@lang('View All')</a>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <div class="widget-two box--shadow2 b-radius--5 bg--white">
                <i class="las la-money-bill overlay-icon text--dark"></i>
                <div class="widget-two__icon b-radius--5 bg--dark">
                    <i class="las la-money-bill"></i>
                </div>
                <div class="widget-two__content">
                    <h3> {{ $general->cur_sym }}{{ showAmount($widget['total_sale_amount']) }}</h3>
                    <p>@lang('Total Sale Amount')</p>
                </div>
                <a class="widget-two__btn border--dark btn-outline--dark border" href="{{ route('admin.order.index') }}">@lang('View All')</a>
            </div>
        </div><!-- dashboard-w1 end -->
    </div><!-- row end-->
...
@push('breadcrumb-plugins')
    ...
    @if ($general->last_cron)
        ...
        btn--danger @endif" href="{{route('cron')}}"><i class="fa fa-fw fa-clock"></i>@lang('Last Cron Run') : {{ Carbon\Carbon::parse($general->last_cron)->difFforHumans() }}</a>
    @endif
