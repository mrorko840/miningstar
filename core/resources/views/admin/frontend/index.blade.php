                                ...
                                @if ($k != 'modal')
                                    @if ($type == 'icon')
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control iconPicker icon" name="{{ $k }}" data-icon="" type="text" autocomplete="off" required>
                                                <span class="input-group-text input-group-addon" data-icon="las la-home" role="iconpicker"></span>
                                            </div>
                                        </div>
                                    @elseif($k == 'select')
                ...
                <div class="input-group">
                    ...
                    <select class="form-control form-control-sm border--primary h-auto" name="tempname" required>
                        ...
                        @foreach ($templates as $template)
                            @php
                                $templateName = @explode('.', $template)[1];
                            @endphp
                            @if ($templateName)
                                <option value="{{ $template }}">{{ __(keyToTitle($templateName)) }}</option>
                            @endif
                        @endforeach
                    </select>
