    ...
    <div class="main-container container">
        ...
        <div class="row mb-3">
            <div class="col-12">
                ...
                <label class="btn bg-blue shadow-sm avatar avatar-44 p-0 mb-3 me-2 text-white"
                    for="btn-color-blue">BL</label>
                ...
                <label class="btn bg-pink shadow-sm avatar avatar-44 p-0 mb-3 me-2 text-white"
                    for="btn-color-pink">PK</label>

                <input type="radio" class="btn-check mb-2" name="color-scheme" id="btn-color-red"
                    data-title="theme-red">
                <label class="btn bg-red shadow-sm avatar avatar-44 p-0 mb-3 me-2 text-white"
                    for="btn-color-red">RD</label>
                ...
                <input type="radio" class="btn-check mb-2" name="color-scheme" id="btn-color-green"
                    data-title="theme-green">
                <label class="btn bg-green shadow-sm avatar avatar-44 p-0 mb-3 me-2 text-white"
                    for="btn-color-green">GN</label>

                <input type="radio" class="btn-check mb-2" name="color-scheme" id="btn-color-teal"
                    data-title="theme-teal">
                <label class="btn bg-teal shadow-sm avatar avatar-44 p-0 mb-3 me-2 text-white"
                    for="btn-color-teal">TL</label>

                <input type="radio" class="btn-check mb-2" name="color-scheme" id="btn-color-cyan"
                    data-title="theme-cyan">
                <label class="btn bg-cyan shadow-sm avatar avatar-44 p-0 mb-3 me-2 text-white"
                    for="btn-color-cyan">CN</label>
            </div>
        </div>
        ...
        <div class="row ">
            <div class="col mb-4">
                ...
                <label class="btn btn-outline-primary background-btn p-1 text-center border-0" for="btn-menu1">
                    <img src="{{ asset($customTemplate . 'img/setting-menu-1@2x.png') }}" alt="" class="mw-100 rounded-10"><br><span
            ...
            <div class="col mb-4 ps-0">
                ...
                <label class="btn btn-outline-primary background-btn p-1 text-center border-0" for="btn-menu2">
                    <img src="{{ asset($customTemplate . 'img/setting-menu-2@2x.png') }}" alt="" class="mw-100 rounded-10"><br><span
            ...
            <div class="col mb-4 ps-0">
                ...
                <label class="btn btn-outline-primary background-btn p-1 text-center border-0" for="btn-menu3">
                    <img src="{{ asset($customTemplate . 'img/setting-menu-3@2x.png') }}" alt="" class="mw-100 rounded-10"><br><span
            ...
            <div class="col-12">
                ...
                <p class="text-muted size-12">Background images are visible on <code>dark-bg</code> class used
                    ...
                    <span class="text-color-theme"
                        onclick="event.stopPropagation(); $('body').addClass('menu-open')">Menu sidebar</span>.
                </p>
            </div>
        </div>
        ...
        <div class="row ">
            <div class="col mb-4">
                ...
                <label class="btn btn-outline-primary background-btn p-1 text-center border-0" for="btn-bg1">
                    <img src="{{ asset($customTemplate . 'img/darkbg-1.png') }}" alt="" class="mw-100 rounded-10"><br><span
            ...
            <div class="col mb-4">
                ...
                <label class="btn btn-outline-primary background-btn p-1 text-center border-0" for="btn-bg2">
                    <img src="{{ asset($customTemplate . 'img/darkbg-2.png') }}" alt="" class="mw-100 rounded-10"><br><span
            ...
            <div class="col mb-4">
                ...
                <label class="btn btn-outline-primary background-btn p-1 text-center border-0" for="btn-bg3">
                    <img src="{{ asset($customTemplate . 'img/darkbg-3.png') }}" alt="" class="mw-100  rounded-10"><br><span
