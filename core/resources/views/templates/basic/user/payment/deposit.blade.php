    ...
    <div class="main-container container">
        ...
        @if ($order)
            <div class="text-center my-3">
                <h5>
                    Pay for - <b class="text-color-theme">{{ __($order->plan_details->title) }}</b>
                </h5>
            </div>
        @else
            <div class="text-center my-3">
                <h5>
                    <b class="text-color-theme">Top Up</b>
                </h5>
            </div>
        @endif
        ...
        <form action="{{ route('user.deposit.insert') }}" method="post">
            ...
            <div class="row">
                <div class="col-12 text-center mb-2">
                    <input class="trasparent-input text-center border" placeholder="0.00" name="amount" type="number" value="{{ $order ? showAmount($order->amount) : old('amount') }}" step="any" autocomplete="off" required @readonly($order)>
                    <div class="text-center my-2"><span class="text-muted">Select Gateway</span>
            ...
            <div class="preview-details d-none my-3">
                <div class="card">
                    <div class="card-body">
                        <ul class="list-group">
                            <li style="background-color: #0000000f;" class="list-group-item d-flex justify-content-between">
                            ...
                            <li style="background-color: #0000000f;" class="list-group-item justify-content-between d-none rate-element">
        
                            </li>
                            <li style="background-color: #0000000f;" class="list-group-item justify-content-between d-none in-site-cur">
                                <span>@lang('In') <span class="method_currency"></span></span>
                                <span class="final_amo fw-bold">0</span>
                            </li>
                            <li style="background-color: #0000000f;" class="list-group-item justify-content-center crypto_currency d-none">
            ...
            <div class="row mb-4">
                <div class="col-12 ">
                    <button class="btn btn-default btn-lg shadow-sm w-100 submit-btn" type="submit">
                        @if ($order)
                            @lang('Pay Now')
                        @else
                            @lang('Add to Wallet')
