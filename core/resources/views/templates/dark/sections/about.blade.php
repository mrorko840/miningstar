        ...
        <div class="row gy-4 flex-wrap-reverse">
            <div class="col-lg-6 pe-lg-5">
                <div class="about-thumb">
                    <img src="{{ getImage('assets/images/frontend/about/' . @$content->data_values->image, '600x500') }}" alt="">
                    <div class="about-thumb__coin">
                        <img src="{{ getImage('assets/images/frontend/about/' . @$content->data_values->coin_image, '100x115') }}" alt="">
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
