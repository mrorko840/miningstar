            ...
            <tbody>
                ...
                @forelse($deposits as $deposit)
                    <tr>
                        ...
                        <td class="text-center">
                            <div>
                                <small class="d-block">{{ __($general->cur_sym) }}{{ showAmount($deposit->amount) }} + <span data-bs-toggle="tooltip" class="text-danger" title="@lang('charge')">{{ showAmount($deposit->charge) }} </span></small>
                        ...
                        <td>
                            <button class="btn--base btn--xsm @if ($deposit->method_code >= 1000) detailBtn @endif" type="button" @if ($deposit->method_code >= 1000) data-info="{{ $details }}" @endif @if ($deposit->status == Status::PAYMENT_REJECT) data-admin_feedback="{{ $deposit->admin_feedback }}" @endif @if ($deposit->method_code < 1000) disabled @endif>
