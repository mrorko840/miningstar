    ...
    Route::middleware(['check.status'])->group(function () {
        ...
        Route::middleware('registration.complete')->namespace('User')->group(function () {
            ...
            Route::controller('UserController')->group(function () {
                ...
                Route::post('/wallets', 'walletUpdate')->name('wallet.update');

                // referral
                Route::get('referral/all', 'referral')->name('referral');
            ...
            Route::controller('ProfileController')->group(function () {
                ...
                Route::post('bio-submit', 'submitBio')->name('bio.submit');
            ...
            Route::controller('OrderPlanController')->group(function () {
                ...
                Route::get('plans/purchased', 'purchasedPlan')->name('plans.purchased');
