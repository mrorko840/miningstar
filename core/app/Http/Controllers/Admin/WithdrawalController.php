...
class WithdrawalController extends Controller
{
    ...
    public function approve(Request $request)
    {
        ...
        $withdraw = Withdrawal::where('status',  Status::PAYMENT_INITIATE)->with('user', 'userCoinBalance.miner')->findOrFail($request->id);
    ...
    public function reject(Request $request)
    {
        ...
        $transaction->details = showAmount($withdraw->amount) . ' ' .  $wallet->miner->coin_code . ' Refunded from withdrawal rejection';
